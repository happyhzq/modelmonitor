...
async function upsertModelRecords(connection: mysql.Connection, records: ModelUsageRecord[]) {
  ...
  const sql = `
    ...
    ON DUPLICATE KEY UPDATE
      ...
      tokens = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(tokens, VALUES(tokens)), VALUES(tokens)),
      prompt_tokens = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(prompt_tokens, VALUES(prompt_tokens)), VALUES(prompt_tokens)),
      completion_tokens = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(completion_tokens, VALUES(completion_tokens)), VALUES(completion_tokens)),
      requests = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(requests, VALUES(requests)), VALUES(requests)),
      active_users = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(active_users, VALUES(active_users)), VALUES(active_users)),
      avg_latency_ms = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(avg_latency_ms, VALUES(avg_latency_ms)), VALUES(avg_latency_ms)),
      coverage = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(coverage, VALUES(coverage)), VALUES(coverage)),
...
async function upsertAgentRecords(connection: mysql.Connection, records: AgentUsageRecord[]) {
  ...
  const sql = `
    ...
    ON DUPLICATE KEY UPDATE
      country = VALUES(country),
      region = VALUES(region),
      invocations = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(invocations, VALUES(invocations)), VALUES(invocations)),
      completed_tasks = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(completed_tasks, VALUES(completed_tasks)), VALUES(completed_tasks)),
      tool_calls = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(tool_calls, VALUES(tool_calls)), VALUES(tool_calls)),
      tokens = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(tokens, VALUES(tokens)), VALUES(tokens)),
      success_rate = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(success_rate, VALUES(success_rate)), VALUES(success_rate)),
      avg_steps = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(avg_steps, VALUES(avg_steps)), VALUES(avg_steps)),
      handoff_rate = IF(source_kind = 'public_stats' AND VALUES(source_kind) = 'public_stats', GREATEST(handoff_rate, VALUES(handoff_rate)), VALUES(handoff_rate)),
      source_id = VALUES(source_id),
      source_kind = VALUES(source_kind),
      is_estimate = VALUES(is_estimate),
      metric_note = VALUES(metric_note),
